...
def main():
    cv_dir = "t:/TryHard_IT_Project/Final/Backend/CV fullstack"
    ...
    print(f"=== BẮT ĐẦU SEED {len(files)} ỨNG VIÊN TỪ THƯ MỤC CV FULLSTACK ===")
        ...
        try:
            ...
            if not found_profile:
                ...
                profile_cur.execute('''
                    ...
                    WHERE "AppUserId" = %s
                ''', (phone, address, random.randint(1, 12), user_id))
                profile_conn.commit()
    ...
    print(f"\n=== KẾT QUẢ SEEDING THƯ MỤC CV FULLSTACK ===")
